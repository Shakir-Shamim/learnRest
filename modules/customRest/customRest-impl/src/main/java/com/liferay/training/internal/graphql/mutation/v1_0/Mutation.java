package com.liferay.training.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	@GraphQLField(description = "Adds a new emp")
	public Emp addApp(@GraphQLName("emp") Emp emp) throws Exception {
		return _applyComponentServiceObjects(
			_empResourceComponentServiceObjects, this::_populateResourceContext,
			empResource -> empResource.addApp(emp));
	}

	@GraphQLField(description = "Removes the emp")
	public boolean deleteApp(@GraphQLName("employeeId") String employeeId)
		throws Exception {

		_applyVoidComponentServiceObjects(
			_empResourceComponentServiceObjects, this::_populateResourceContext,
			empResource -> empResource.deleteApp(employeeId));

		return true;
	}

	@GraphQLField(description = "Updates the emp")
	public Emp updateApp(
			@GraphQLName("employeeId") String employeeId,
			@GraphQLName("emp") Emp emp)
		throws Exception {

		return _applyComponentServiceObjects(
			_empResourceComponentServiceObjects, this::_populateResourceContext,
			empResource -> empResource.updateApp(employeeId, emp));
	}

 ...
 * <code>com.liferay.training.service.impl.EmpLocalServiceImpl</code> and
...
public class EmpLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.training.service.impl.EmpLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new emp
	 */
	public static Emp createEmp(String employeeId) {
		return getService().createEmp(employeeId);
	}
	 ...
	 */
	public static Emp deleteEmp(String employeeId) throws PortalException {
		return getService().deleteEmp(employeeId);
	}
	...
	public static Emp fetchEmp(String employeeId) {
		return getService().fetchEmp(employeeId);
	}
	 ...
	 * @throws PortalException if a emp with the primary key could not be found
	 */
	public static Emp getEmp(String employeeId) throws PortalException {
		return getService().getEmp(employeeId);
	}
